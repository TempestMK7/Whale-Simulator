    ...
    public class MissionInfo {
        ...
        public PotentialRewardsContainer RewardsForMission() {
            ...
            return new PotentialRewardsContainer() {
                ...
                RedCrystalsMin = (int)Math.Ceiling(HeroAwakening / 4.0),
                RedCrystalsMax = (int)Math.Ceiling(HeroAwakening / 2.0),
                BlueCrystalsMin = -3,
                BlueCrystalsMax = HeroAwakening > 5 ? 1 : 0,
                SilverDustMin = 1,
                SilverDustMax = 100 + 10 * HeroAwakening,
                GoldDustMin = -100,
                GoldDustMax = -50 + (10 * HeroAwakening),
                OldPagesMin = -2,
                OldPagesMax = HeroAwakening / 3,
                AncientPagesMin = -9,
                AncientPagesMax = HeroAwakening / 6,
                TreatsMin = 3,
                TreatsMax = 7,
                TreatsMaxSize = HeroAwakening / 3,
